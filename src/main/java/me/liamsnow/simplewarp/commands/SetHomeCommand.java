...
public class SetHomeCommand implements CommandExecutor {
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
		...
		DataStore gpDataStore = SimpleWarp.griefPrevention.dataStore;
		...
		signPersistentData.set(new NamespacedKey(SimpleWarp.instance, Constants.PERSISTENT_DATA_TAG_KEY), PersistentDataType.INTEGER, Constants.TAG_SIGN_WARP_SPAWN);
